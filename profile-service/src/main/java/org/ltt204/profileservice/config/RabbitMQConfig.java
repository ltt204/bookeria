package org.ltt204.profileservice.config;
...
public class RabbitMQConfig {
    ...
    @NonFinal
    @Value("${producer-service.event.created}")
    String EVENT_CREATED;

    @NonFinal
    @Value("${producer-service.event.updated}")
    String EVENT_UPDATED;

    @NonFinal
    @Value("${producer-service.event.deleted}")
